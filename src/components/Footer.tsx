        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            ...
            <a
              ...
              className="w-8 h-8 rounded-full border border-charcoal/20 flex items-center justify-center hover:border-gold hover:text-gold text-charcoal/40 transition-all"
